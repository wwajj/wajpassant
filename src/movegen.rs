...
use crate::attacks::{KING_ATTACKS, KNIGHT_ATTACKS, get_bishop_attacks, get_rook_attacks};
...
pub fn generate_knight_moves(
    ...
    while pieces.0 != 0 {
        ...
        let all_moves = unsafe { KNIGHT_ATTACKS[start as usize] & !friendly_occupancy };
...
pub fn generate_king_moves(
    ...
    while pieces.0 != 0 {
        let start = pieces.pop_lsb();
        let all_moves = unsafe { KING_ATTACKS[start as usize] & !friendly_occupancy };
        let mut captures = all_moves & enemy_occupancy;
        let mut quiets = all_moves & !total_occupancy;
